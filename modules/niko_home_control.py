...
class NikoHomeControlAPI:
    ...
    def __init__(self, host: str, username: str, jwt_token: str, ca_cert_path: str = None):
        ...
        """
        self.host = 'Niko5C9F.local' if host is None else host
    ...
    def _connect_mqtt(self, retries: int = 3, delay: float = 1.0):
        ...
        for attempt in range(retries):
            try:
                self.mqtt_client.connect(self.host, self.mqtt_port, keepalive=60)
                self.mqtt_client.loop_start()

                # Wait for connection to establish
                wait_time = 0
                while not self._connected and wait_time < 30:
                    time.sleep(5)
                    wait_time += 5
    ...
    def _on_message(self, client, userdata, message):
        ...
        try:
            ...
            if isinstance(params, list):
                # When Params is a list, extract devices/locations from first item
    ...
    def get_dimmer_status(self, device_uuid: str) -> Dict:
        """
        Get current status of a dimmer device.
    ...
    def list_devices_in_location(self, location_uuid: str) -> List[Dict]:
        ...
        try:
            ...
            # We need to properly extract the devices
            for param in response["Params"]:
    ...
    def get_devices_by_location(self) -> Dict[str, Dict]:
        ...
        Args:
            niko: Authenticated NikoHomeControlAPI instance
    ...
    def _mqtt_request(self, request_topic: str, response_topic: str, payload: Dict,
        ...
        Raises:
            TimeoutError: If no response is received within timeout period
        """
        self.ensure_connection()
        ...
        # Temporarily subscribe to response topic
    ...
    def identify_comfort_sensors(self) -> List[Dict]:
        ...
        for device in all_devices:
            # Check if device has properties we care about
